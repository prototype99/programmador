...
LICENSE="GPL-2"
SLOT="0"
IUSE="ldap fastcgi passenger imagemagick -lighttpd -systemd -suburi -postgres -sqlite -mysql -default-dispatch"

# 1. At least one supported database should be required.
# 2. Provided config files with lighttpd support are written for systemd and fastcgi.
...
REQUIRED_USE="|| ( postgres sqlite mysql )
